...
```{r echo=FALSE}
if(!identical(readLines("../Data/references.bib"), character(0))){
  child_refs_1L_chr <- c("../Child_RMDs/MS_References.Rmd")
}else{
  child_refs_1L_chr <- NULL
}
```

```{r, child = child_refs_1L_chr, echo=FALSE}
```
